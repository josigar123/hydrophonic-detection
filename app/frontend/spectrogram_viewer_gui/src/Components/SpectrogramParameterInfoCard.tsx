const SpectrogramParameterInfoCard = () => {
  const generalParams = [
    { name: 'Select window', description: 'Desired window to use' },
    {
      ...
      description: 'Time per segment, equivalent to nperseg in spectrogram calculation',
    },
    {
      name: 'freqFilt (frequency filter [S])',
      description: 'No. of frequency bins used for vertical smoothing prior to spectrogram normalization',
    },
    {
    ...
    },
    {
      ...
      description: 'Upper bound on frequency axis',
    },
    {
      name: 'minFreq (minimum frequency [Hz])',
      description: 'Lower bound on frequency axis',
    },
    {
      name: 'maxDb (maximum decibel [dB])',
      description: 'Upper bound on decibel axis',
    },
    {
      name: 'minDb (minimum decibel [dB])',
      description: 'Lower bound on decibel axis',
    },
  ];
  ...
  const spectrogramParams = [
    {
      ...
      description:
        'Decibel threshold for narrowband detection',
    },
  ];
